...
if __name__ == '__main__':  # при import выполняться не будет
    i = 1000
    true_false_change = []

    # при смене
    for itm in range(i):
        true_false_change.append(open_the_door(True))
    ...
    # без смены
    for itm in range(i):
        true_false.append(open_the_door(False))
